          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-gray-2 text-left dark:bg-meta-4">
                ...
                <th className="min-w-[260px] py-4 px-4 font-medium text-black dark:text-white xl:pl-6">
                  Task
                </th>
                <th className="min-w-[130px] py-4 px-4 font-medium text-black dark:text-white">
                  Customer
                </th>
                <th className="min-w-[200px] py-4 px-4 font-medium text-black dark:text-white xl:pl-5">
                  Project
                </th>
